...
public class YPT_7520 {
    ...
    @Test
    public void Django1() throws IOException, InterruptedException {
       ...
       // driver.get(url);
        ...
        List<WebElement> categories = driver.findElements(By.id("id"));
    ...
    @Test
    public void Django2() throws IOException, InterruptedException {
        ...
        driver.findElement(By.id("id_password")).sendKeys("user", Keys.ENTER);
        //  categories.get(3).click();
